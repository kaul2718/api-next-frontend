...
const LoginPage = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (responseNextAuth?.error) {
      const errorMessages = responseNextAuth.error.split(",");
      setErrors(errorMessages);
      // Mostrar notificación de error con react-toastify
      errorMessages.forEach(error => toast.error(error)); // Muestra una notificación de error
      return;
    }

    router.push("/dashboard");
    toast.success("Iniciado sesión correctamente!"); // Muestra una notificación de éxito
  };
  ...
  return (
    <div className="d-flex vh-100 justify-content-center align-items-center">
      ...
      >
        ...
        >
          <img src="/banco.png" alt="Logo" className="mb-3" style={{ width: "100px" }} />
